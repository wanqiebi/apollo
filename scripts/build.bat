...
set dev_meta="http://localhost:6002"
set fat_meta="http://localhost:6002"
set uat_meta="http://localhost:6002"
set lpt_meta="http://localhost:6002"
set pro_meta="http://localhost:6002"

set META_SERVERS_OPTS=-Ddev_meta=%dev_meta% -Dfat_meta=%fat_meta% -Duat_meta=%uat_meta% -Dlpt_meta=%lpt_meta% -Dpro_meta=%pro_meta%
